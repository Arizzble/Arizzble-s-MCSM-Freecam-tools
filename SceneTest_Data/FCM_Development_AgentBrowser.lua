...
Custom_CutsceneDev_BuildSceneAgentList = function()
    ...
    for i, sceneAgent in ipairs(allSceneAgents) do
        ...
        local originalVisibility = AgentSetProperty(sceneAgentName, "Runtime: Visible", Custom_CutsceneDev_SceneObject); --bool type
...
Custom_CutsceneDev_UpdateCutsceneTools_Main = function()  
    ...
    local currentCamera_fov = AgentSetProperty(currentCamera_name, "Field of View", Custom_CutsceneDev_SceneObject); --number type
